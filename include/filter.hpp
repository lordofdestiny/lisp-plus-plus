...
constexpr auto filter_single(std::index_sequence<I>, Predicate pred) {
...
constexpr auto concat_sequences(std::index_sequence<s...>,
                                std::index_sequence<t...>, R...) {
...
template <size_t... I, typename Predicate>
constexpr auto filter_index_sequence(std::index_sequence<I...>,
                                     Predicate pred) {
